...
class ModelOptions:
    def __init__(self):
        ...
        parser.add_argument('--patch-stride', type=int, default=0, metavar='N', help='How far the centers of two consecutive patches are in the image (default: 256)')
        parser.add_argument('--patch-stride1', type=int, default=0, metavar='N', help='How far the centers of two consecutive patches are in the image (default: 256)')
        parser.add_argument('--patch-stride2', type=int, default=0, metavar='N', help='How far the centers of two consecutive patches are in the image (default: 256)')
