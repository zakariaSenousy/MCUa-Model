...
class ImageWiseModel2(BaseModel2):
    def __init__(self, args, image_wise_network, patch_wise_network):
        super(ImageWiseModel2, self).__init__(args, image_wise_network, args.checkpoints_path + '/weights2P6_' + image_wise_network.name() + '.pth')
    ...
    def test(self, path, verbose=True, ensemble= True):
        ...
        if verbose:
            print('P6 Context-aware ResNet Scale II')
